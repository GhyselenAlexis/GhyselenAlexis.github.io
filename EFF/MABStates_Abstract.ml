...
In practice, this file must implement all the types/function described in RL_Abstract.mli
...
let abstractobs (o : env_obs) :obs = let (r,s) = o in s ;;

let abs_MABS max = let l = list_enumerate 1 (max + 1) in 
  handler 
